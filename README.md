...
[![Go Report Card](https://goreportcard.com/badge/github.com/UrbanCompass/ladon)](https://goreportcard.com/report/github.com/UrbanCompass/ladon)
[![GoDoc](https://godoc.org/github.com/UrbanCompass/ladon?status.png)](https://godoc.org/github.com/UrbanCompass/ladon)
...
```
go get github.com/UrbanCompass/ladon
```
...
```go
import "github.com/UrbanCompass/ladon"
...
There are also adapters available written by the community [for Redis and RethinkDB](https://github.com/UrbanCompass/ladon-community)
...
import (
	...
	manager "github.com/UrbanCompass/ladon/manager/memory"
)
...
```go
import "github.com/UrbanCompass/ladon"
import manager "github.com/UrbanCompass/ladon/manager/sql"
...
```go
import "github.com/UrbanCompass/ladon"
import manager "github.com/UrbanCompass/ladon/manager/memory"
...
**Create mocks**
```sh
mockgen -package ladon_test -destination manager_mock_test.go github.com/UrbanCompass/ladon Manager
```
...
- [Redis and RethinkDB](https://github.com/UrbanCompass/ladon-community)
